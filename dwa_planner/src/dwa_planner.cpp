...
DWAPlanner::Cost::Cost(
  const float dist_cost, const float obs_cost,
...
float DWAPlanner::calc_dist_cost(
...
float DWAPlanner::calc_velocity_cost(
...
void DWAPlanner::state_simulation(
